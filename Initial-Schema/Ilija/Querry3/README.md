...
## Statistika upita 
![Upit3-PreOptimizacije-Statistics](../assets/q3.1.png)
![Upit3-PreOptimizacije-Statistics](../assets/q3.2.png)

## Zaključak 

**Ukupno vreme trajanja upita:** 17 sekundi

**Broj ulaznih dokumenata:** 60 hiljada

Prilikom analiziranja explain naredbe, uočava se da je najviše vremena utrošeno na operaciju lookup koja pokusava da dobavi ime tima preko skracenice. 
